...
% VERSION: BATCH ANALYSIS 
% THIS VERSION IS FOR THE VIDEOS 1 FRAME PER MINUTE
function [output] = Batch_Count_Lawn_leaving(fullFileName, baseFileName)
%% Load the video
...
th_1 = 0.0035;  % Tried at 0.0035 for all and not so good
th_2 = 0.0035;  % Tried at 0.0030 but maybe only the last bck needs 0.003
th_3 = 0.003;  % 0.0025
...
% This is pretty much the output you care about.
vid_countBlobs = [];
vid_estimated_worms = [];
vid_fr_multi_blob = [];
...
Name = baseFileName(1 : (length(baseFileName) - 4));
